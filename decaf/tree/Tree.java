...
public abstract class Tree {
    ...
    public static final int PRINTCOMP = READLINEEXPR + 1;
    public static final int PRINT = PRINTCOMP + 1;
    public static final int ACASEEXPR = PRINT + 1;
    public static final int DCOPY = ACASEEXPR + 1;
    public static final int SCOPY = DCOPY + 1;
    public static final int DOSTMT = SCOPY + 1;
    public static final int DOBRANCH = DOSTMT + 1;
    public static final int SUPEREXPR = DOBRANCH + 1;
...
// new class ----------------------------------------------------------------
    ...
    public static class DoStmt extends Tree {
        ...
        public List<DoBranch> doBranchList;
        
        public DoStmt(List<DoBranch> doBranchList, Location loc) {
            super(DOSTMT, loc);
            this.doBranchList = doBranchList;
        }
    ...
    public static class DoBranch extends Tree {
        ...
        public DoBranch(Expr condition, Tree stmt, Location loc) {
            super(DOBRANCH, loc);
            this.condition = condition;
            this.stmt = stmt;
        }
    ...
    public static class Case extends Expr {
        public Expr condition;
        public List<ACaseExpr> caseList;
        public Expr defaultExpr;
                    
        public Case(Expr condition, List<ACaseExpr> caseList, Expr defaultExpr, Location loc) {
            super(CASE, loc);
            this.condition = condition;
    ...
    /**
      * Echo one case expression
      */
    public static class ACaseExpr extends Tree {
        public Expr caseCont;
        public Expr expr;
        
        public ACaseExpr(Expr caseCont, Expr expr, Location loc){
            super(ACASEEXPR, loc);
...
// new -----------------------------------------
        ...
        public void visitACaseExpr(ACaseExpr that) {
            visitTree(that);
        }
